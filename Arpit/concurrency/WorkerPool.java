...
public class WorkerPool {
    ...
    public static void main(String args[]) throws InterruptedException{
        ...
        ThreadPoolExecutorTest monitor = new ThreadPoolExecutorTest(executorPool, 3);
...
class ThreadPoolExecutorTest implements Runnable {

	private ThreadPoolExecutor executor;
	private int seconds;
	private boolean run = true;

	public ThreadPoolExecutorTest(ThreadPoolExecutor executor, int delay) {
